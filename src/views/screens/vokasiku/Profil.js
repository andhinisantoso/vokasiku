      ...
      <View style={style.navigatorContainer}>
        <TouchableOpacity activeOpacity={0.5} style={style.icon}>
          <View style={{alignItems:'center'}}>
            ...
            <Text style={{fontSize: 12, color: COLORS.primary, textAlign: 'center'}}>Beranda</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity activeOpacity={0.5} style={style.icon}>
          <View style={{alignItems:'center'}}>
            <Entypo name="text-document" size={28} color={COLORS.secondary}/>
        ...
        <TouchableOpacity activeOpacity={0.5} style={style.icon}>
          <View style={{alignItems:'center'}}>
          <MaterialCommunityIcons name="certificate-outline" size={28} color={COLORS.secondary}/>
            <Text style={{fontSize: 12, color: COLORS.toska, textAlign: 'center'}}>Sertifikat</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity activeOpacity={0.5} style={style.icon}>
          <View style={{alignItems:'center'}}>
            <Ionicons name="md-person-outline" size={28} color={COLORS.secondary}/>
            <Text style={{fontSize: 12, color: COLORS.toska, textAlign: 'center'}}>Profil</Text>
          </View>
        </TouchableOpacity>
    </View>
        </View>
