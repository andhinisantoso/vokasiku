...
import progres from '../../../const/categoriesProgres';
  ...
  return (
    <ScrollView style={{flex: 1, backgroundColor: COLORS.white, paddingBottom: 15, paddingRight: 15, paddingLeft: 15}}>
      ...
      <View style={{marginLeft: 10}}>
          ...
          <Text style={{color: COLORS.dark}}>Kelas</Text>
          <Text style={{color: COLORS.dark}}>Progres:</Text>
          <Text style={{color: COLORS.dark}}>11/27 pelajaran</Text>
      <View style={{height: 15, width: 240, backgroundColor: COLORS.light, borderRadius: 10}}>
      < View style={{height: 15, width: 60, backgroundColor: COLORS.yellow, borderRadius: 10}}>
      </View>
      </View>
      </View>
      </View>
      ...
      <TouchableOpacity activeOpacity={0.5} style={style.icon}>
        ...
        <TouchableOpacity activeOpacity={0.5} style={style.icon}>
          <View style={{alignItems:'center'}}>
          <Ionicons name="book-outline" size={28} color={COLORS.toska}/>
            <Text style={{fontSize: 12, color: COLORS.toska, textAlign: 'center'}}>Belajar</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity activeOpacity={0.5} style={style.icon}>
          <View style={{alignItems:'center'}}>
